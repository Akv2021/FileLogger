...
var fileLog = function (data) {
    ...
    if (typeof data == 'string' || typeof data == 'undefined'){
        ...
        var defaultValues = {
            ...
            folder: "folderSize",//"dm",//"fiautoupload",//"northernArc",//"soa_bulk_upload",//"astuteInt", // put all logs in this dir, default "logs"
            enable: true, // enable false to force stop all
            aflName: "insuranceDm",//"fibugs",//"compressor",//"incred",//"sendNrthrnArc",//"astuteflow_11", // use this to give append file name - to enable, give data.name = 'afl'
        ...
        if(data.name == 'afl'){
            ...
            data.append = data.first ? false : data.append;
        }
